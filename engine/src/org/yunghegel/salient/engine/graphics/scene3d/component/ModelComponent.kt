...
class ModelComponent(model:ID,go: GameObject, modelAsset: ModelAsset? = null) : EntityComponent<Model>(Model::class.java,null,go) {
    ...
    private var usedAsset : ModelAsset? = modelAsset
        set(value) {
