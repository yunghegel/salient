...
class UVSphereSupplier : InstanceSupplier {
    ...
    override fun createModel(): Model? {
        ...
        val stepTheta: Float = InstanceSupplier.Companion.PI / rings.toFloat()
        val stepPhi: Float = InstanceSupplier.Companion.TWO_PI / segments.toFloat()
