...
class GridShader(val config : Config = Config()) : BaseShader(){
    ...
    class Config(var minPixelsBetweenCells:Float = 2.0f,var gridCellSize:Float =0.025f,var gridColorThin:Color = Color(0.2f,0.2f,0.2f,1f),var gridColorThick:Color = Color(0.25f,0.25f,0.25f,1f),var gridSize:Float = 50f) {

        fun set(gridSize: Float, gridCellSize: Float, minPixelsBetweenCells: Float, gridColorThin: Color, gridColorThick: Color) {
    ...
    class GridShaderProvider(val config: Config = Config()) : BaseShaderProvider() {
    ...
    override fun render(renderable: Renderable?) {
        ...
        set(UNIFORM_CAMERA_POSITION,camera.position)
