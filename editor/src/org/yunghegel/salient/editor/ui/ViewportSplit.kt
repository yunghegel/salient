...
class ViewportSplit(val viewportPanel : ViewportPanel,val tabPanel : TabPanel) : ConstrainedMultiSplitPane(false) {
...
//            if we have at least 2 actors, swap their order
    ...
    fun cacheRange(actor: Actor) {
        ...
        rangeResolution[actor] = {
            ...
            Range.of(start,end).toNormalized(width)
        }
