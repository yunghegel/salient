...
class OutlineSystem(val outliner: OutlineDepth) : BaseSystem("outline_system", org.yunghegel.salient.editor.plugins.rendering.State.DEPTH_PASS.ordinal, Family.all(
