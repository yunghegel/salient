...
const vec2 u_scale = vec2(15.0, 15.0);
...
void main()
{
  ...
  p0_3d = u_projViewWorldTrans * p0_3d;
  // 2D position
  vec2 p0 = p0_3d.xy / p0_3d.w;

	// Compute the vertex position in the usual fashion.
  p1_3d = u_projViewWorldTrans * p1_3d;
  // 2D position
  vec2 p1 = p1_3d.xy / p1_3d.w;

	// Compute the vertex position in the usual fashion.
  p2_3d = u_projViewWorldTrans * p2_3d;
  // 2D position
  ...
  // and v2 = p2-p0
  vec2 v10 = u_scale *(p1 - p0);
  vec2 v20 = u_scale *(p2 - p0);
  ...
  // and v21 = p2-p1
  vec2 v01 = u_scale *(p0 - p1);
  vec2 v21 = u_scale *(p2 - p1);
  ...
  // and v12 = p1-p2
  vec2 v02 = u_scale *(p0 - p2);
  vec2 v12 = u_scale *(p1 - p2);
